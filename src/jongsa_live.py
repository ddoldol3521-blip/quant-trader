...
# 기존 주문 프리셋 위에 별도 보조매매를 얹은 연구 후보들이다. 기본 프리셋과
# 주문 구조가 다르므로 PRESETS에 섞지 않는다. 오늘 주문 화면에서 실제 주문을
# 만들 수 있게 된 후보만 나중에 PRESETS로 승격한다.
CANDIDATE_STRATEGIES = {
    "RSI16 안정형": {
        "CAGR": 37.62460459933084,
        "MDD": -40.33938974930615,
        "CAGR_gain": 0.46258271608987656,
        "MDD_change": 0.06402278538431005,
        "entries": 31,
        "status": "강건성 검증 통과",
        "rule": "SOXX 150일 추세와 SOXL RSI16을 보고 큰 하락 때만 소액 보조매수",
    },
    "RSI14 성장형": {
        "CAGR": 37.69109709558733,
        "MDD": -40.33527508580756,
        "CAGR_gain": 0.5290752123463704,
        "MDD_change": 0.06813744888290074,
        "entries": 36,
        "status": "성장 우선 후보",
        "rule": "RSI16 안정형보다 RSI 반응을 빠르게 해 보조매수 기회를 늘림",
    },
    "SafeA": {
        "CAGR": 37.3345710627633,
        "MDD": -40.33797444269134,
        "CAGR_gain": 0.17254917952234194,
        "MDD_change": 0.06543809199911976,
        "entries": 11,
        "status": "단순·보수 후보",
        "rule": "전일 대비 -11% 급락과 RSI14 35 이하가 겹칠 때만 1% 보조매수",
    },
    "Stochastic 보강형": {
        "CAGR": 37.74079121586493,
        "MDD": -40.27492629678624,
        "CAGR_gain": 0.5787693326239705,
        "MDD_change": 0.12848623790421954,
        "entries": 31,
        "status": "신규 후보",
